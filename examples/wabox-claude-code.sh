...
#   PROCESSED_DIR         where to park inbox files once we pick them up
#                         (default: $WABOX_INBOX/processed)
...
#   KEEP_PROCESSED        1 = keep envelopes in PROCESSED_DIR for audit (default 1)
#                         0 = delete envelopes after the reply is written
